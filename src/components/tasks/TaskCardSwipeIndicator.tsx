...
import { ArrowRight, CheckCircle, RotateCcw, Pencil, Trash2 } from 'lucide-react';
...
const TaskCardSwipeIndicator = ({
  ...
  if (swipeOffset > 0) {
    ...
    return (
      <div className="absolute left-0 top-0 bottom-0 flex items-center justify-center w-12 bg-destructive/10 text-destructive">
